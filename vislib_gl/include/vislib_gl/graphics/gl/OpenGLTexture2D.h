...
public:
     ...
     *         otherwise.
     */
    GLenum Create(const uint32_t width, const uint32_t height, const void* pixels = NULL, const GLenum format = GL_RGBA,
        const GLenum type = GL_UNSIGNED_BYTE, const GLint internalFormat = GL_RGBA, const GLint border = 0);
     ...
     *         otherwise.
     */
    GLenum Create(const uint32_t width, const uint32_t height, const bool forcePowerOfTwo, const void* pixels = NULL,
        const GLenum format = GL_RGBA, const GLenum type = GL_UNSIGNED_BYTE, const GLint internalFormat = GL_RGBA,
     ...
     *         otherwise.
     */
    GLenum Update(const void* pixels, const uint32_t width, const uint32_t height, const GLenum format = GL_RGBA,
        const GLenum type = GL_UNSIGNED_BYTE, const uint32_t offsetX = 0, const uint32_t offsetY = 0,
